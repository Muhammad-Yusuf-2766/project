...
export default function SellerDashboard() {
	const [activeTab, setActiveTab] = useState<'overview' | 'my-products'>(
		'overview',
	)
	...
	return (
		<div className='min-h-screen bg-background'>
			<div className='bg-linear-to-r from-secondary to-background text-text py-8'>
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<h1 className='text-3xl font-bold'>
						Baoshqaruvchilar uchun Dashboard
					</h1>
							...
							<div className='flex flex-col md:flex-row items-center justify-between'>
								<div>
									...
									<p className='text-emerald-50'>
										Add more products to increase your revenue
									</p>
								</div>
					...
					<div className='bg-white rounded-xl shadow-lg'>
						...
						<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6'>
							{myProducts.map(product => (
								<div
									key={product.id}
									className='bg-white border-2 border-gray-200 rounded-xl overflow-hidden hover:border-emerald-500 transition-all'
								>
